<?php
  ...
  $sql = "SELECT SONG.NAME , SONG.URL_IMG, SONG.SONG_URL, SINGER.NAME as 'SINGER_NAME' from SONG INNER JOIN SINGER ON SONG.SINGER_ID = SINGER.ID WHERE SONG.SINGER_ID = $singerId";
