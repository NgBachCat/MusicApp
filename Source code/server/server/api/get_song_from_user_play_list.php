<?php
  ...
  $idPlayList = $_GET['playListId'];
  $sql = "SELECT SONG.*, SINGER.NAME as SINGER_NAME 
  FROM SONG 
  INNER JOIN DETAIL_USER_PLAYLIST ON SONG.ID = DETAIL_USER_PLAYLIST.SONG_ID 
  INNER JOIN SINGER ON SONG.SINGER_ID = SINGER.ID 
  WHERE DETAIL_USER_PLAYLIST.PLAYLIST_ID = $idPlayList";
